        ...
        <div class="row">
            <div class="col-md-12 center-image">
                ...
                if (isset($_FILES['uploaded_image'])) {
                    $upload_dir = 'C:/xampp/htdocs/'; // Passe diesen Pfad an, um zum htdocs-Ordner deines Servers zu gelangen.

                    $file_name = $_FILES['uploaded_image']['name'];
                    $file_path = $upload_dir . $file_name;

                    if (move_uploaded_file($_FILES['uploaded_image']['tmp_name'], $file_path)) {
                        echo "<img src='$file_name' alt='Frittiertes Bild' class='responsive-image'>";
                    } else {
